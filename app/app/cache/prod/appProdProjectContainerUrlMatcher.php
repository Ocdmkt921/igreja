...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/sms')) {
            // mautic_sms_callback
            if (preg_match('#^/sms/(?P<transport>[^/]++)/callback$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_sms_callback')), array (  '_controller' => 'Mautic\\SmsBundle\\Controller\\ReplyController::callbackAction',));
            }

            // mautic_receive_sms
            if ('/sms/receive' === $pathinfo) {
                return array (  'transport' => 'twilio',  '_controller' => 'Mautic\\SmsBundle\\Controller\\ReplyController::callbackAction',  '_route' => 'mautic_receive_sms',);
            }
